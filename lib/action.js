    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (customTag) {
            ...
            if (commitMethod == 'tag') {
                ...
                const baseRef = (_c = (_b = (_a = github_1.context === null || github_1.context === void 0 ? void 0 : github_1.context.payload) === null || _a === void 0 ? void 0 : _a.pull_request) === null || _b === void 0 ? void 0 : _b.base) === null || _c === void 0 ? void 0 : _c.sha;
                commits = yield (0, utils_1.getCommits)(baseRef, commitRef);
            }
            else {
        ...
        yield (0, github_2.createTag)(newTag, createAnnotatedTag, commitRef);
    });
}
