...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let validTags;
        validTags = yield utils_1.getValidTags(prefixRegex);
        let latestTag = utils_1.getLatestTag(validTags, prefixRegex, tagPrefix);
        ...
        if (customTag) {
            ...
            if (latestVersion) {
                ...
                previousVersion = semver_1.parse(latestVersion);
                validTags = yield github_1.listTags();
                previousTag = yield utils_1.getPreviousTag(tagPrefix);
