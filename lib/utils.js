...
exports.mapCustomReleaseRules = exports.getLatestPrereleaseTag = exports.getLatestTag = exports.isPr = exports.getBranchFromRef = exports.getCommits = exports.getPreviousTag = exports.getValidTags = void 0;
...
function getPreviousTag(tagPrefix) {
    return __awaiter(this, void 0, void 0, function* () {
        const tags = yield github_1.listTags();
        return (tags.find((tag) => tag !== undefined) || {
