    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!latestPrereleaseTag) {
                ...
                // @ts-ignore
                previousTag = semver_1.parse(semver_1.gte(latestTag.name, latestPrereleaseTag.name) ? latestTag.name : latestPrereleaseTag.name);
            }
            ...
            const releaseType = isPrerelease ? 'prerelease' : (bump || defaultBump);
