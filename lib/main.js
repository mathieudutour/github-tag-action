...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const semverRegex = /(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)(?:-(?:0|[1-9]\d*|[\da-z-]*[a-z-][\da-z-]*)(?:\.(?:0|[1-9]\d*|[\da-z-]*[a-z-][\da-z-]*))*)?(?:\+[\da-z-]+(?:\.[\da-z-]+)*)?(?=$|\s)/gi;
            const semverTagArray = semverRegex.exec(tag);
            const semverTag = semverTagArray ? semverTagArray[0] : tag;
            const newVersion = `${semver_1.inc(semverTag, bump || defaultBump)}${preRelease ? `-${GITHUB_SHA.slice(0, 7)}` : ""}`;
            ...
            if (createAnnotatedTag === "true") {
                ...
                const tagCreateResponse = yield octokit.git.createTag(Object.assign(Object.assign({}, github_1.context.repo), { tag: newTag, message: message, object: GITHUB_SHA, type: "commit" }));
