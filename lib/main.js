...
function getCommits(githubToken, sha) {
    return __awaiter(this, void 0, void 0, function* () {
        const octokit = new github_1.GitHub(githubToken);
        const commits = yield octokit.repos.listCommits(Object.assign(Object.assign({}, github_1.context.repo), { per_page: 100, sha: sha }));
        return commits.data
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const tags = yield getValidTags(githubToken);
            const previousTag = tags[0];
            let previousTagName;
            let logs;
            if (previousTag) {
                previousTagName = semver_1.parse(previousTagName.name);
            }
            else {
            ...
            const commits = yield getCommits(githubToken, previousTag.commit.sha);
            ...
            const incrementedVersion = semver_1.inc(previousTagName, releaseType, appendToPreReleaseTag ? appendToPreReleaseTag : currentBranch);
